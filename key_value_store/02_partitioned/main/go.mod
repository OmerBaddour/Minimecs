...
replace (
	github.com/OmerBaddour/Minimecs/key_value_store/02_partitioned/common => ../common
	github.com/OmerBaddour/Minimecs/key_value_store/02_partitioned/key_value_worker => ../key_value_worker
	github.com/OmerBaddour/Minimecs/key_value_store/02_partitioned/web_server => ../web_server
)
